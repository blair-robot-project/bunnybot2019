...
public class AllianceRobotMap {
    ...
    /**
     * The switch for which alliance we're on.
     */
    @NotNull
    private final DigitalInput onRedSwitch;
     ...
     */
    @JsonCreator
    public AllianceRobotMap(@Nullable List<CommandButton> buttons,
                            @NotNull @JsonProperty(required = true) Logger logger,
                            @NotNull @JsonProperty(required = true) MappedRunnable updater,
                            @NotNull @JsonProperty(required = true) MappedDigitalInput onRedSwitch,
    ...
    @NotNull
    public DigitalInput getOnRedSwitch() {
        return onRedSwitch;
    }
}
